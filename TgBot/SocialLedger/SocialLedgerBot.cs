...
namespace TgBot.SocialLedger
{
    public class SocialLedgerBot : ITGBotApp
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                var service = serviceProvider.GetService<SocialLedgerDbService>();
                            ...
                            if (msg.Text != null)
                            {
                                if (msg.Text.StartsWith("/start", StringComparison.CurrentCultureIgnoreCase))
                                {
                                    ...
                                    else if (parts.Length == 2)
                                    {
                                        ...
                                        {
                                            await TGBot.PushDialog(msg.From.Id.ToString(), new ProcessRequestDialog(service, msg.Chat.Id, msg.From,
