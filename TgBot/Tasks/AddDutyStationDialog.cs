...
namespace TgBot.Tasks
{
    public class AddDutyStationDialog : FormDialog
    {
        ...
        public AddDutyStationDialog(TaskDbService service,TgDbService tgService, ChatId chatId, User from) : base(chatId, from)
        {
        ...
        protected override async Task<DialogResult> OnCompleteAsync(ITelegramBotClient bot, CancellationToken cancellationToken)
        {
            ...
            await SetTaskFlowDialog.NotifyDutyStationCreation(bot,tgService, ds, cancellationToken);
            return DialogResult.Terminated;
